                ...
                <el-card>
                    ...
                    <div>
                        ...
                        <el-table :data="dataList" border v-loading="dataListLoading"
                            ...
                            <el-table-column prop="parValue" header-align="center" align="center" label="参数值">
                            </el-table-column>
                            <el-table-column prop="menuUrl" header-align="center" align="center" label="参数url">
                            </el-table-column>
                            <el-table-column prop="type" header-align="center" align="center" label="参数类型">
                            </el-table-column>
...
<script>
import AddOrUpdate from "./paramAddOrUpdate";
    ...
    methods: {
        ...
        menuListTreeCurrentChangeHandle(data, node) {
            let route = this.dynamicMenuRoutes.filter(
                item => item.meta.menuId === data.menuId
            );
            if (route.length >= 1) {
